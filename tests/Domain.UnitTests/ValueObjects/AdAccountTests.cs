using company_event_management.Domain.Exceptions;
using company_event_management.Domain.ValueObjects;
using Shouldly;
using Xunit;

namespace company_event_management.Domain.UnitTests.ValueObjects
{
