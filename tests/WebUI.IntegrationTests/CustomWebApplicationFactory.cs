...
namespace company_event_management.WebUI.IntegrationTests
{
    public class CustomWebApplicationFactory<TStartup> : WebApplicationFactory<TStartup> where TStartup : class
    {
        ...
        {
            return await GetAuthenticatedClientAsync("jason@clean-architecture", "company_event_management!");
        }
        ...
        private async Task<string> GetAccessTokenAsync(HttpClient client, string userName, string password)
        {
            ...
            var response = await client.RequestPasswordTokenAsync(new PasswordTokenRequest
            {
                ...
                ClientId = "company_event_management.IntegrationTests",
                ClientSecret = "secret",

                Scope = "company_event_management.WebUIAPI openid profile",
                UserName = userName,
                Password = password
            });
